	...
	while 1:
		...
		if(q=='end'):
			...
			if choice in ['Y','y','\n']:
				...
				continue
			# continue
		opt=raw_input("Enter Your Options ")
...
def main():
	...
	print(s.recv(4096)+"\n\n")
	print "-------------------------------------------------------\n"
	u_name=raw_input('Enter Username ').strip()
	print "\n"

	u_password=raw_input('Enter Password ').strip()
	print "\n"
	print "**********************************************************\n"
	...
	while((u_name=='' or u_password=='') and i>0):
		...
		print'Number of Attempts remaining %s \n\n'%i
		i-=1
		u_name=raw_input('Enter Username ')
		print "\n"

		u_password=raw_input('Enter Password ')
		print "\n"
